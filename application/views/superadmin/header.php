...
<head>
    ...
    <title>SUPERADMIN - SI LLAJ</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url() ?>assets/admin/images/favicon.png">
    <!-- Pignose Calender -->
    <link href="<?php echo base_url() ?>assets/admin/plugins/pg-calendar/css/pignose.calendar.min.css" rel="stylesheet">
    <!-- Chartist -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/plugins/chartist/css/chartist.min.css">
            ...
            <div class="brand-logo">
                <a href="index.html">
                    ...
                    <span class="brand-title">
                        <img src="<?php echo base_url() ?>assets/admin/images/dishubkota.png" style="width:100px;">
                    </span>
                </a>
            </div>
        </div>
